...
- පිළිතුරු සංක්ෂිප්ත කරන්න — සරල ප්‍රශ්නවලට වාක්‍ය 3–4 ක් ප්‍රමාණවත්. ගැඹුරු ශාස්ත්‍රීය ප්‍රශ්නවලට පමණක් වැඩි විස්තර ලබා දෙන්න.
- ප්‍රශ්නය නැවත සඳහන් කිරීමෙන් හෝ ප්‍රතිනිර්මාණය කිරීමෙන් වළකින්න. කෙලින්ම පිළිතුරෙන් ආරම්භ කරන්න.
- පෞද්ගලික මත හෝ සදාචාරාත්මක විනිශ්චය ඉදිරිපත් නොකරන්න.
...
- பதில்களை சுருக்கமாக வைக்கவும் — எளிய கேள்விகளுக்கு 3–4 வாக்கியங்கள் போதும். ஆழமான கேள்விகளுக்கு மட்டும் அதிக விவரங்கள் தேவை.
- கேள்வியை மீண்டும் கூறுவதோ மொழிபெயர்ப்பதோ வேண்டாம். நேரடியாக பதிலிலிருந்து தொடங்கவும்.
...
def _translate_query_to_english(question: str, religion: str = "Buddhism") -> str:
    ...
    _step1_system["Islam"] = (
        "You are a translator. Translate the following Sinhala or Tamil question into "
        "concise English suitable for an Islamic scripture search. "
        "You MUST use correct Islamic terminology. "
        "Key mappings: "
        "සලාතය / தொழுகை = salah / prayer. "
        "කීප වතාවක් / எத்தனை முறை = how many times per day. "
        "ෆජ්ර් = Fajr, ධුහ්ර් = Dhuhr, අස්ර් = Asr, මග්රිබ් = Maghrib, ඊෂා = Isha. "
        "රමදාන් = Ramadan. සකාත් = zakat. හජ් = Hajj. "
        "කුර්ආන් = Quran. හදීස් = hadith. නබිතුමා / நபி = Prophet Muhammad. "
        "ජිහාද් = jihad. ශිර්ක් = shirk. ජන්නත් = jannah. ජහන්නම් = jahannam. "
